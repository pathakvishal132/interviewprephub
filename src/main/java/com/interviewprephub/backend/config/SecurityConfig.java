    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/coding/company/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/coding/question/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/coding/question/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/coding/run").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/coding/submit").authenticated()
